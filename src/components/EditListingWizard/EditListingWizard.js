...
const tabLabel = (intl, tab, user_name = null) => {
  ...
  if (tab === DESCRIPTION) {
    key = ['EditListingWizard.tabLabelDescription',user_name].join('.');
  } else if (tab === FEATURES) {
    key = ['EditListingWizard.tabLabelFeatures',user_name].join('.');
  } else if (tab === POLICY) {
    key = ['EditListingWizard.tabLabelPolicy',user_name].join('.');
  } else if (tab === LOCATION) {
    key = ['EditListingWizard.tabLabelLocation',user_name].join('.');
  } else if (tab === PRICING) {
    key = ['EditListingWizard.tabLabelPricing',user_name].join('.');
  } else if (tab === AVAILABILITY) {
    key = ['EditListingWizard.tabLabelAvailability',user_name].join('.');
  } else if (tab === PHOTOS) {
    key = ['EditListingWizard.tabLabelPhotos',user_name].join('.');
  } else if (tab === HOME) {
    key = ['EditListingWizard.tabLabelHome',user_name].join('.');
  }
